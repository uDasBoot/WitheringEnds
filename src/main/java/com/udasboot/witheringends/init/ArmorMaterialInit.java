...
public enum ArmorMaterialInit implements IArmorMaterial {
	TITANIUM("titanium", 37, new int[] { 4, 7, 9, 4 }, 22, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.3F, () -> {
	...
	private ArmorMaterialInit(String p_i231593_3_, int p_i231593_4_, int[] p_i231593_5_, int p_i231593_6_,
